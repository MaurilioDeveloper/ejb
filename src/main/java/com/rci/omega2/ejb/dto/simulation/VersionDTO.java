...
public class VersionDTO extends BaseDTO {
    ...
    private List<VehicleVersionOptionsDTO> options;
    ...
    public List<VehicleVersionOptionsDTO> getOptions() {
        return options;
    }

    public void setOptions(List<VehicleVersionOptionsDTO> options) {
