...
public class DossierVehicleAccessoryDAO extends BaseDAO {
    
    private static final Logger LOGGER = LogManager.getLogger(DossierVehicleAccessoryDAO.class);
    ...
    public void deleteByDossier(Long dossierId) throws UnexpectedException {
        ...
        try {
            ...
            sql.append("    delete from DossierVehicleAccessoryEntity pe    ");
